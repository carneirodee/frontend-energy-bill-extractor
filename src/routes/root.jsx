...
export default function Root() {
    return (
        <>
            <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" className="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
            ...
            <aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 " aria-label="Sidebar">
                <div className="h-full px-3 py-4 overflow-y-auto bg-green-950 dark:bg-gray-800 rounded-r-large">
                    ...
                    <ul className="space-y-2 font-medium">
                        <li>
                            <a className="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-green-900 dark:hover:bg-green-700 hover:text-gray-100 group">
                                ...
                                <a className="ms-3" href={`/dashboard`}>Dashboard</a>
                            </a>
                        </li>
                        <li>
                            <a className="flex items-center p-2 text-white  rounded-lg dark:text-white hover:bg-green-900 dark:hover:bg-green-700 hover:text-gray-100 group">
                                ...
                                <a className="ms-3" href={`/faturas`}>Faturas</a>
                            </a>
                        </li>
                    </ul>
                </div>
            </aside>
            <div id="detail" className="p-4 sm:ml-64">
                <Outlet />
            </div>
        </>
    );
